...
export const Docs = () => (
  ...
  <Page title="Remark Fancy Tables" description="">
    ...
    <p>
      ...
      complicated, style-related syntax is limited to table cell alignment only.
    </p>
    ...
    <p>
      ...
      provides a <code>data-nth-cell</code> HTML attribute for each table cell
      (1-indexed), so you can style each individual cell using CSS/JS that way
    </p>
  </Page>
);
